...
function NDVIMNDWI_func(
    ::Type{TFL}, N::Number, R::Number, G::Number, S1::Number
) where {TFL<:Number}
...
function MBI_func(
    ::Type{TFL}, S1::Number, S2::Number, N::Number; const1::Number=TFL(0.5)
) where {TFL<:Number}
...
function WRI_func(
    ::Type{TFL}, G::Number, R::Number, N::Number, S1::Number
) where {TFL<:Number}
    return (G + R) / (N + S1)
end
...
function NDISIg_func(
    ...
    N::Number,
    S1::Number;
    const1::Number=TFL(3.0),
    const2::Number=TFL(3.0),
) where {TFL<:Number}
...
function IRECI_func(
    ::Type{TFL}, RE3::Number, R::Number, RE1::Number, RE2::Number
) where {TFL<:Number}
...
function NBRplus_func(
    ::Type{TFL}, S2::Number, N2::Number, G::Number, B::Number
) where {TFL<:Number}
...
function FCVI_func(
    ::Type{TFL}, N::Number, R::Number, G::Number, B::Number; const1::Number=TFL(3.0)
) where {TFL<:Number}
...
function ExG_func(
    ::Type{TFL}, G::Number, R::Number, B::Number; const1::Number=TFL(2)
) where {TFL<:Number}
    return const1 * G - R - B
end
...
function GSAVI_func(
    ::Type{TFL}, L::Number, N::Number, G::Number; const1::Number=TFL(1.0)
) where {TFL<:Number}
...
function MLSWI27_func(
    ::Type{TFL}, N::Number, S2::Number; const1::Number=TFL(1.0), const2::Number=TFL(1.0)
) where {TFL<:Number}
...
function TVI_func(
    ::Type{TFL}, N::Number, R::Number; const1::Number=TFL(0.5), const2::Number=TFL(0.5)
) where {TFL<:Number}
...
function BI_func(
    ::Type{TFL}, S1::Number, R::Number, N::Number, B::Number
) where {TFL<:Number}
...
function RDVI_func(
    ::Type{TFL}, N::Number, R::Number; const1::Number=TFL(0.5)
) where {TFL<:Number}
...
function ARI_func(
    ::Type{TFL}, G::Number, RE1::Number; const1::Number=TFL(1), const2::Number=TFL(1)
) where {TFL<:Number}
...
function NBRSWIR_func(
    ::Type{TFL}, S2::Number, S1::Number; const1::Number=TFL(0.02), const2::Number=TFL(0.1)
) where {TFL<:Number}
...
function OCVI_func(
    ::Type{TFL}, N::Number, G::Number, R::Number, cexp::Number
) where {TFL<:Number}
    return (N / G) * (R / G)^cexp
end
...
function SARVI_func(
    ::Type{TFL}, L::Number, N::Number, R::Number, B::Number; const1::Number=TFL(1)
) where {TFL<:Number}
...
function DpRVIVV_func(
    ::Type{TFL}, VH::Number, VV::Number; const1::Number=TFL(4.0)
) where {TFL<:Number}
...
function ExR_func(
    ::Type{TFL}, R::Number, G::Number; const1::Number=TFL(1.3)
) where {TFL<:Number}
    return const1 * R - G
end
...
function CIG_func(
    ::Type{TFL}, N::Number, G::Number; const1::Number=TFL(1.0)
) where {TFL<:Number}
    return (N / G) - const1
end
...
function ANDWI_func(
    ::Type{TFL}, B::Number, G::Number, R::Number, N::Number, S1::Number, S2::Number
) where {TFL<:Number}
...
function NWI_func(
    ::Type{TFL}, B::Number, N::Number, S1::Number, S2::Number
) where {TFL<:Number}
...
function GARI_func(
    ::Type{TFL}, N::Number, G::Number, B::Number, R::Number
) where {TFL<:Number}
...
function MCARI705_func(
    ::Type{TFL}, RE2::Number, RE1::Number, G::Number; const1::Number=TFL(0.2)
) where {TFL<:Number}
...
function SWM_func(
    ::Type{TFL}, B::Number, G::Number, N::Number, S1::Number
) where {TFL<:Number}
    return (B + G) / (N + S1)
end
...
function SAVI_func(
    ::Type{TFL}, L::Number, N::Number, R::Number; const1::Number=TFL(1.0)
) where {TFL<:Number}
...
function EVI2_func(
    ::Type{TFL}, g::Number, N::Number, R::Number, L::Number; const1::Number=TFL(2.4)
) where {TFL<:Number}
...
function DPDD_func(
    ::Type{TFL}, VV::Number, VH::Number; const1::Number=TFL(2.0), const2::Number=TFL(0.5)
) where {TFL<:Number}
...
function EBI_func(
    ::Type{TFL}, R::Number, G::Number, B::Number, epsilon::Number
) where {TFL<:Number}
...
function ARVI_func(
    ::Type{TFL}, N::Number, R::Number, gamma::Number, B::Number
) where {TFL<:Number}
...
function GOSAVI_func(
    ::Type{TFL}, N::Number, G::Number; const1::Number=TFL(0.16)
) where {TFL<:Number}
...
function OSAVI_func(
    ::Type{TFL}, N::Number, R::Number; const1::Number=TFL(0.16)
) where {TFL<:Number}
    return (N - R) / (N + R + const1)
end
...
function AFRI2100_func(
    ::Type{TFL}, N::Number, S2::Number; const1::Number=TFL(0.5), const2::Number=TFL(0.5)
) where {TFL<:Number}
...
function MCARI_func(
    ::Type{TFL}, RE1::Number, R::Number, G::Number; const1::Number=TFL(0.2)
) where {TFL<:Number}
    return ((RE1 - R) - const1 * (RE1 - G)) * (RE1 / R)
end
...
function MLSWI26_func(
    ::Type{TFL}, N::Number, S1::Number; const1::Number=TFL(1.0), const2::Number=TFL(1.0)
) where {TFL<:Number}
...
function DBI_func(
    ::Type{TFL}, B::Number, T1::Number, N::Number, R::Number
) where {TFL<:Number}
...
function DpRVIHH_func(
    ::Type{TFL}, HV::Number, HH::Number; const1::Number=TFL(4.0)
) where {TFL<:Number}
...
function MBWI_func(
    ::Type{TFL}, omega::Number, G::Number, R::Number, N::Number, S1::Number, S2::Number
) where {TFL<:Number}
...
function SEVI_func(
    ::Type{TFL}, N::Number, R::Number, fdelta::Number; const1::Number=TFL(1.0)
) where {TFL<:Number}
...
function TRRVI_func(
    ::Type{TFL}, RE2::Number, R::Number, N::Number; const1::Number=TFL(1.0)
) where {TFL<:Number}
...
function DBSI_func(
    ::Type{TFL}, S1::Number, G::Number, N::Number, R::Number
) where {TFL<:Number}
...
function NLI_func(
    ::Type{TFL}, N::Number, R::Number; const1::Number=TFL(2), const2::Number=TFL(2)
) where {TFL<:Number}
...
function CSIT_func(
    ::Type{TFL}, N::Number, S2::Number, T::Number; const1::Number=TFL(10000.0)
) where {TFL<:Number}
...
function CIRE_func(
    ::Type{TFL}, N::Number, RE1::Number; const1::Number=TFL(1)
) where {TFL<:Number}
    return (N / RE1) - const1
end
...
function NIRvH2_func(
    ::Type{TFL}, N::Number, R::Number, k::Number, lambdaN::Number, lambdaR::Number
) where {TFL<:Number}
...
function CVI_func(
    ::Type{TFL}, N::Number, R::Number, G::Number; const1::Number=TFL(2.0)
) where {TFL<:Number}
    return (N * R) / (G^const1)
end
...
function RI4XS_func(
    ::Type{TFL}, R::Number, G::Number; const1::Number=TFL(2.0), const2::Number=TFL(4.0)
) where {TFL<:Number}
...
function AFRI1600_func(
    ::Type{TFL}, N::Number, S1::Number; const1::Number=TFL(0.66), const2::Number=TFL(0.66)
) where {TFL<:Number}
...
function TSAVI_func(
    ::Type{TFL}, sla::Number, N::Number, R::Number, slb::Number
) where {TFL<:Number}
...
function SAVI2_func(
    ::Type{TFL}, N::Number, R::Number, slb::Number, sla::Number
) where {TFL<:Number}
    return N / (R + (slb / sla))
end
...
function DSWI5_func(
    ::Type{TFL}, N::Number, G::Number, S1::Number, R::Number
) where {TFL<:Number}
    return (N + G) / (S1 + R)
end
